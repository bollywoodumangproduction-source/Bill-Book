...
function seedDB(): MockDB {
  ...
  const partners: Partner[] = [
    { id: uuid(), name: 'Vikash Thakur', mobile: '9800011111', studio_name: '', studio_address: '', category: 'Photographer Freelancer', status: 'Active', note: 'Wedding & pre-wedding specialist', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800011111'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Saurav Anand', mobile: '9800022222', studio_name: '', studio_address: '', category: 'Photographer Freelancer', status: 'Active', note: 'Nikah & event coverage', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800022222'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Deepak Kumar', mobile: '9800033333', studio_name: '', studio_address: '', category: 'Photographer Freelancer', status: 'Active', note: 'Drone operator', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800033333'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Sharma Studio', mobile: '9800044444', studio_name: 'Sharma Studio', studio_address: 'Laheriasarai, Darbhanga', category: 'Studio Freelancer', status: 'Active', note: 'Video mixing partner', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800044444'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Smile Photography', mobile: '9800055555', studio_name: 'Smile Photography', studio_address: 'Kamtaul, Darbhanga', category: 'Studio Freelancer', status: 'Inactive', note: 'Album design — seasonal', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800055555'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Royal Films', mobile: '9800066666', studio_name: 'Royal Films', studio_address: 'Madhubani', category: 'Studio Freelancer', status: 'Active', note: 'Color grading & post', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800066666'.slice(-4), password_changed: false },
    { id: uuid(), name: 'Ravi Equipment Rentals', mobile: '9800077777', studio_name: '', studio_address: '', category: 'Other', status: 'Active', note: 'Lens & lighting rentals', trashed_at: null, created_at: isoNow(), updated_at: isoNow(), is_login_allowed: true, portal_password: '9800077777'.slice(-4), password_changed: false },
  ];
